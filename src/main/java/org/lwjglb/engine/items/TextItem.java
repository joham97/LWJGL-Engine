...
public class TextItem extends GameItem {
    ...
    private Mesh buildMesh() {
        ...
        for(int i=0; i<numChars; i++) {
            ...
            textCoords.add( (float)charInfo.getStartX() / (float)this.fontTexture.getWidth());
            textCoords.add(0.0f);
            ...
            positions.add((float)this.fontTexture.getHeight()); //y
            positions.add(ZPOS); //z
            textCoords.add((float)(charInfo.getStartX() + charInfo.getWidth() )/ (float)this.fontTexture.getWidth());
            textCoords.add(1.0f);
